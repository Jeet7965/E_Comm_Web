...
import {clearAllItems, removeItems, IncreseItems, decreaseItem } from "../redux_tools/Slicer"
            ...
            <div>
                <div className="container mx-auto p-6">
                    ...
                    <div className="space-y-6">
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center justify-between bg-white p-4 rounded shadow space-y-4 md:space-y-0">
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center justify-between sm:space-x-4 w-full sm:w-auto">
                                            <div className="flex items-center space-x-2 mb-2 sm:mb-0">
                                                ...
                                                <span className="text-lg font-medium">{item.quantity ? item.quantity : 1}</span>
                                                <button
                        ...
                        <hr />
                        <div className="text-right  mt-8  flex  justify-between items-center">
                            <button  onClick={handlePlace} className="px-4 py-2 bg-green-500 text-white rounded hover:bg-orange-600">Place Order</button>
